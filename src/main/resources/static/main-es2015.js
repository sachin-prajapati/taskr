...
let HomeComponent = class HomeComponent {
    constructor(document, serverservice) {
        this.serverservice = serverservice;
        this.myStyle = {};
        this.myParams = {};
        this.width = 100;
...
let ServerService = class ServerService {
    ...
    signUpUser(fullName, userName, email, password, confirmPassword) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        // console.log(JSON.stringify({name,email,password}));
        return this.http.post(this.rootUrl + '/api/auth/signUp', JSON.stringify({ fullName, userName, email, password, confirmPassword }), { headers: headers });
    }
    logInUser(email, password) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        console.log(JSON.stringify({ email, password }));
        return this.http.post(this.rootUrl + '/api/auth/login', JSON.stringify({ email, password }), { headers: headers });
    }
    verifyUser(otp, name) {
        console.log(name);
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.post(this.rootUrl + '/api/auth/verifyEmail/' + name, JSON.stringify({ otp }), { headers: headers });
    }
    resendOtp(name) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
    ...
    addBoard(bName) {
        ...
        return this.http.post(this.rootUrl + '/api/board/create', JSON.stringify({ bName }), { headers: headers });
    }
    getUserBoards() {
        const token = localStorage.getItem('token');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    addList(name, id) {
        ...
        return this.http.post(this.rootUrl + '/api/board/addList/' + id, JSON.stringify({ name }), { headers: headers });
    }
    updateBoard(bName, description, id) {
        const token = localStorage.getItem('token');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': `Bearer ` + token,
        });
        return this.http.patch(this.rootUrl + '/api/board/update/' + id, JSON.stringify({ bName, description }), { headers: headers });
    }
    bookmark(bookmark, id) {
        ...
        return this.http.put(this.rootUrl + '/api/board/addToFavourite/' + id, JSON.stringify({ bookmark }), { headers: headers });
    }
    addCard(name, listid, boardid) {
        const token = localStorage.getItem('token');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': `Bearer ` + token,
        });
        return this.http.post(this.rootUrl + '/api/board/addCard/' + boardid + '/' + listid, JSON.stringify({ name }), { headers: headers });
    }
    updateCard(name, description, priority, boardid, listid, cardid) {
        const token = localStorage.getItem('token');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': `Bearer ` + token,
        });
        return this.http.patch(this.rootUrl + '/api/board/updateCard/' + boardid + '/' + listid + '/' + cardid, JSON.stringify({ name, description, priority }), { headers: headers });
    }
    getActivityboard(boardid) {
        const token = localStorage.getItem('token');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': `Bearer ` + token,
    ...
    addMemberToBoard(memberUsername, boardid) {
        const token = localStorage.getItem('token');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': `Bearer ` + token,
        });
        return this.http.patch(this.rootUrl + '/api/board/addMember/' + boardid, JSON.stringify({ memberUsername }), { headers: headers });
    }
    ...
    setduedate(dueDate, dueTime, reminderBefore, boardid, listid, cardid) {
        const token = localStorage.getItem('token');
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json',
            'Authorization': `Bearer ` + token,
        });
        return this.http.put(this.rootUrl + '/api/board/setDueDate/' + boardid + '/' + listid + '/' + cardid, JSON.stringify({ dueDate, dueTime, reminderBefore }), { headers: headers });
    }
};
...
let UserComponent = class UserComponent {
    constructor(boardsservice, serverservice) {
...
let VerificationComponent = class VerificationComponent {
    constructor(serverservice, route, router) {
        this.serverservice = serverservice;
        this.route = route;
        this.router = router;
        this.resend = false;
